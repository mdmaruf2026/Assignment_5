...
function displayIssues(issues){
    ...
    issues.forEach(issue => {
        ...
        div.innerHTML = ` <div class="CardContainerHIGH w-full h-full border border-[#64748B]  border-t-4 border-t-[#00A96E]  px-4">
            ...
            <div class="HIGHcardMain">
                <p class="font-semibold text-[14px] text-[#1F2937] mt-2 mb-1" >
                ${issue.title}</p>
